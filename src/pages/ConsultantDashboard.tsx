...
import { InteractiveSidebar } from "../components/nolum-dashboard/dashboard/InteractiveSidebar";
import { InteractiveNavigation } from "../components/nolum-dashboard/dashboard/InteractiveNavigation";
import { InteractiveClientCard } from "../components/nolum-dashboard/dashboard/InteractiveClientCard";
import { ComparativeChart } from "../components/nolum-dashboard/dashboard/ComparativeChart";
import { ClientPieChart } from "../components/nolum-dashboard/dashboard/ClientPieChart";
import { SimpleProductLifecycles } from "../components/nolum-dashboard/dashboard/SimpleProductLifecycles";
import { Footer } from "../components/nolum-dashboard/dashboard/Footer";
import { ClientsPage } from "../components/nolum-dashboard/dashboard/ClientsPage";
import { ClientDetailsPage } from "../components/nolum-dashboard/dashboard/ClientDetailsPage";
...
export default function ConsultantDashboard() {
  ...
  const handlePageChange = (page: string) => {
    ...
    if (page === "overview") {
      ...
      navigate("/nolum/clients");
    }
  };

  const handleClientSelect = (clientId: string) => {
    navigate(`/nolum/clients/${clientId}`);
  };
