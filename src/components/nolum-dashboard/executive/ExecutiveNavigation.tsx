...
export function ExecutiveNavigation({ onMenuClick, dashboardType: _dashboardType, onDashboardTypeChange: _onDashboardTypeChange }: ExecutiveNavigationProps) {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <div className="px-2 py-1.5">
                ...
                <p className="text-xs text-gray-500">delphine@enies.com</p>
              </div>
              <DropdownMenuItem>Profile Settings</DropdownMenuItem>
              <DropdownMenuItem>Team Management</DropdownMenuItem>
              <DropdownMenuItem>Preferences</DropdownMenuItem>
              <DropdownMenuItem className="text-red-600" onClick={() => { localStorage.removeItem('pulseflow_auth'); window.location.href = '/login'; }}>Sign out</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
