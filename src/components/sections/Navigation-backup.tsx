      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-3 text-xl font-bold text-gray-900">PulseFlow</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#consultants" className="text-gray-700 hover:text-primary-500 font-medium transition-colors">
              For Consultants
            </a>
            <a href="#executives" className="text-gray-700 hover:text-primary-500 font-medium transition-colors">
              For Executives
            </a>
            <a href="#pricing" className="text-gray-700 hover:text-primary-500 font-medium transition-colors">
              Pricing
            </a>
            <a href="#login" className="text-gray-700 hover:text-primary-500 font-medium transition-colors">
              Log in
            </a>
          </div>
